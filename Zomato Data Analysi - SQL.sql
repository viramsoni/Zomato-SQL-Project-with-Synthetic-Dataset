...
-- 3. Find the average order value per customers who has placed more than 750 orders.
...
-- 12. Segment customers into gold/silver group based on their total spending. Compare the average order value; if the customer's total spending exceed the AOV label them as gold, otherwise label them as silver.
